...
from src.simple_mlops.entity.config_entity import (DataIngestionConfig, DataValidationConfig, DataTransformationConfig, ModelTrainerConfig) 
class ConfigurationManager:
    ...
    def get_data_transformation_config(self) -> DataTransformationConfig:
        ...
        create_directories([config.root_dir])          # <- list brackets, like  other calls
