...
from src.simple_mlops.utils.common import save_json, read_yaml, create_directories
...
class ModelEvaluation:
    ...
    def log_into_mlflow(self):
        ...
        with mlflow.start_run():
            ...
            scores = {"rmse": rmse, "mae": mae, "r2": r2}          # define once
            ...
            logger.info(f"Logged metrics to MLflow: {scores}")     # scores is in scope here